...
$(document).ready(function () {
    ...
    window.gMapsCallback = function(){
      ...
      function loadGoogleMaps(){
        ...
        script_tag.setAttribute("src","https://maps.googleapis.com/maps/api/js?key=AIzaSyAcbZ5RSSMLD-LsEWsG3R-bf-b-6ulyMqw&callback=initMap&libraries=places");
